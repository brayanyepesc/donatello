...
<div class="min-h-screen w-full bg-black">
	<div class="flex flex-col items-center justify-center space-y-5 pt-40 text-white">
		<h2
			class="max-w-5xl bg-gradient-to-r from-pink-500 via-red-500 to-indigo-500 bg-clip-text text-5xl font-bold text-transparent"
		>
			Indulge in happiness with every bite — treat yourself to our freshly baked donuts today!
		</h2>
		<span class="text-3xl font-light text-white">The best site to buy donuts</span>
		<button
	...
	<ul class="mt-10 grid grid-cols-3 gap-5">
